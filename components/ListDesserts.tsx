      ...
      {data.map((item) => (
        ...
        >
          <div className='relative mb-8'>
            ...
            />
            <button
              className='flex gap-2 items-center w-36 p-2 bg-[var(--Rose-50)] rounded-full  border-2 border-[var(--Rose-500)] absolute -bottom-4 right-[50%] translate-x-[50%] hover:font-bold transition-all'
          ...
          <p className='text-[var(--Rose-900)] font-semibold'>
